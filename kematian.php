...
<head>
    ...
    <title>Surat Keterangan Kematian - Desa Wonosari</title>
    ...
    <style>
        ...
        * { box-sizing: border-box; font-family: 'Figtree', sans-serif; }
        ...
        /* PDF Styles - Meniru layout Surat Kematian */
        #pdfTemplate {
            display: none; 
            width: 210mm;
            padding: 15mm 20mm;
...
<main>
    <div class="container-form">
        <header class="form-header">
            <h1><br>Layanan Akta Kematian</h1>
        </header>

        <div id="successAlert" class="alert">Draft surat kematian berhasil dibuat!</div>

        <div id="formSection">
            <!-- DATA JENAZAH -->
            <div class="card">
                <div class="section-title">Data Jenazah (Orang yang Meninggal)</div>
                <div class="form-grid">
                    <div class="form-group full-width"><label>Nama Lengkap</label><input type="text" id="nama" placeholder="Contoh: SUTRISNO" required></div>
                    ...
                    <div class="form-group"><label>Tempat Lahir</label><input type="text" id="tempat_lahir" required></div>
                    <div class="form-group"><label>Tanggal Lahir</label><input type="date" id="tgl_lahir" required></div>
                    ...
                    <div class="form-group"><label>Pekerjaan Terakhir</label><input type="text" id="pekerjaan" required></div>
                    <div class="form-group full-width"><label>Alamat Terakhir</label><textarea id="alamat" rows="2" placeholder="RT/RW Desa Wonosari..."></textarea></div>
                </div>
            </div>

            <!-- DATA KEMATIAN -->
            <div class="card">
                <div class="section-title">Detail Waktu & Lokasi Kematian</div>
                <div class="form-grid">
                    <div class="form-group"><label>Hari Kematian</label>
                        <select id="hari_mati">
                    ...
                    <div class="form-group"><label>Tanggal Kematian</label><input type="date" id="tgl_mati" required></div>
                    <div class="form-group"><label>Waktu/Jam (Opsional)</label><input type="text" id="jam_mati" placeholder="Contoh: 08:30 WIB"></div>
                    <div class="form-group"><label>Tempat Meninggal</label><input type="text" id="tempat_mati" placeholder="Contoh: Rumah Kediaman / RSUD Kendal" required></div>
                    <div class="form-group full-width"><label>Penyebab Kematian</label><input type="text" id="sebab_mati" placeholder="Contoh: Sakit Biasa / Usia Tua"></div>
                </div>
            </div>

            <div class="btn-container">
                <button type="button" onclick="generatePreview()" class="btn-primary">Buat Draft Surat Kematian</button>
            </div>
        </div>

        <div id="previewArea">
            <div class="card">
                <h2 style="margin-top:0; color: var(--primary)">Pratinjau Surat Kematian</h2>
                <p>Silahkan periksa data jenazah dan waktu kejadian sebelum mengunduh.</p>
                <div class="btn-container">
...
<div id="pdfTemplate">
    ...
    <div class="surat-title">
        ...
        <p>Nomor : 474.3 / <span id="pdf_no_urut">...</span> / II / 2024</p>
    </div>
    ...
    <div class="content-section">
        ...
        <table class="data-table" style="margin-left: 20px;">
            ...
            <tr><td>Alamat Terakhir</td><td>:</td><td id="pdf_alamat"></td></tr>
        </table>

        <p style="margin-top: 10px;">Telah meninggal dunia pada :</p>
        
        <table class="data-table" style="margin-left: 20px;">
            <tr><td width="160">Hari</td><td width="15">:</td><td id="pdf_hari_mati"></td></tr>
            <tr><td>Tanggal</td><td>:</td><td id="pdf_tgl_mati"></td></tr>
            <tr><td>Pukul / Jam</td><td>:</td><td id="pdf_jam_mati"></td></tr>
            <tr><td>Tempat Meninggal</td><td>:</td><td id="pdf_tempat_mati"></td></tr>
            <tr><td>Sebab Meninggal</td><td>:</td><td id="pdf_sebab_mati"></td></tr>
        </table>

        <p style="margin-top: 15px;">Demikian Surat Keterangan Kematian ini dibuat dengan sebenarnya, untuk dapat dipergunakan sebagaimana mestinya.</p>
    </div>
...
<script>
    ...
    function generatePreview() {
        const data = {
            ...
            ttl: document.getElementById('tempat_lahir').value + ", " + formatDate(document.getElementById('tgl_lahir').value),
            agama: document.getElementById('agama').value,
            kerja: document.getElementById('pekerjaan').value,
            alamat: document.getElementById('alamat').value,
            
            hari_mati: document.getElementById('hari_mati').value,
            tgl_mati: formatDate(document.getElementById('tgl_mati').value),
            jam_mati: document.getElementById('jam_mati').value || "-",
            tempat_mati: document.getElementById('tempat_mati').value,
            sebab_mati: document.getElementById('sebab_mati').value || "Sakit Biasa"
        };
        ...
        setVal('pdf_hari_mati', data.hari_mati);
        setVal('pdf_tgl_mati', data.tgl_mati);
        setVal('pdf_jam_mati', data.jam_mati);
        setVal('pdf_tempat_mati', data.tempat_mati);
        setVal('pdf_sebab_mati', data.sebab_mati);
    ...
    function downloadPDF() {
        ...
        const opt = {
            margin: 0,
            filename: 'Surat_Kematian_' + document.getElementById('nama').value + '.pdf',
