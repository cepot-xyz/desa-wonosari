...
<head>
    ...
    <title>Surat Keterangan Datang - Desa Wonosari</title>
    ...
    <style>
        ...
        * { box-sizing: border-box; font-family: 'Figtree', sans-serif; }
        ...
        /* PDF Styles - Khusus Surat Keterangan Datang */
        #pdfTemplate {
            display: none; 
            width: 210mm;
            padding: 15mm 20mm;
...
<main>
    <div class="container-form">
        <header class="form-header">
            <h1><br>Layanan Surat Keterangan Datang Kependudukan</h1>
        </header>

        <div id="successAlert" class="alert">Draft surat datang berhasil dibuat!</div>

        <div id="formSection">
            <div class="card">
                <div class="section-title">Data Identitas Asal (Daerah Asal)</div>
                <div class="form-grid">
                    ...
                    <div class="form-group"><label>Nomor KK Asal</label><input type="text" id="no_kk" maxlength="16" placeholder="16 Digit No. KK Asal" required></div>
                    ...
                    <div class="form-group"><label>Tempat, Tgl Lahir</label><input type="text" id="ttl" placeholder="Contoh: Semarang, 20-08-1995" required></div>
                    ...
                    <div class="form-group full-width"><label>Alamat Asal Lengkap</label><textarea id="alamat_asal" rows="2" placeholder="Jl. Merdeka No. 10, Desa Maju, Kec. Jaya..."></textarea></div>
                </div>
            </div>

            <div class="card">
                <div class="section-title">Data Tujuan Datang (Desa Wonosari)</div>
                <div class="form-grid">
                    <div class="form-group full-width"><label>Alamat Baru di Wonosari</label><input type="text" id="alamat_baru" placeholder="Dusun / RT / RW" required></div>
                    <div class="form-group"><label>Tanggal Kedatangan</label><input type="date" id="tgl_datang" required></div>
                    <div class="form-group"><label>Alasan Datang</label>
                        <select id="alasan">
            ...
            <div class="btn-container">
                <button type="button" onclick="generatePreview()" class="btn-primary">Buat Draft SKD</button>
            </div>
        </div>

        <div id="previewArea">
            <div class="card">
                <h2 style="margin-top:0; color: var(--primary)">Pratinjau Surat Datang</h2>
                <p>Data kedatangan telah siap. Silahkan periksa format surat di bawah.</p>
                <div class="btn-container">
...
<div id="pdfTemplate">
    ...
    <div class="surat-title">
        <h3>SURAT KETERANGAN DATANG</h3>
        <p>Nomor : 471 / <span id="pdf_no_urut">...</span> / II / 2024</p>
    </div>

    <div class="content-section">
        <p>Yang bertanda tangan di bawah ini Kepala Desa Wonosari Kecamatan Pegandon Kabupaten Kendal, dengan ini menerangkan bahwa :</p>
        ...
        <table class="data-table" style="margin-left: 20px;">
            ...
            <tr><td>Nomor KK Asal</td><td>:</td><td id="pdf_no_kk"></td></tr>
        ...
        <p style="margin-top: 10px;">Orang tersebut di atas benar-benar telah datang dan melaporkan diri untuk menetap di Desa Wonosari dengan keterangan :</p>
        
        <table class="data-table" style="margin-left: 20px;">
            <tr><td width="160">Alamat Baru</td><td width="15">:</td><td id="pdf_alamat_baru"></td></tr>
            <tr><td>Desa / Kelurahan</td><td>:</td><td>Wonosari</td></tr>
            <tr><td>Kecamatan</td><td>:</td><td>Pegandon</td></tr>
            <tr><td>Kabupaten / Kota</td><td>:</td><td>Kendal</td></tr>
            <tr><td>Tanggal Datang</td><td>:</td><td id="pdf_tgl_datang"></td></tr>
            <tr><td>Alasan Datang</td><td>:</td><td id="pdf_alasan"></td></tr>
        </table>

        <p style="margin-top: 15px;">Demikian Surat Keterangan Datang ini dibuat dengan sebenarnya untuk dapat dipergunakan sebagaimana mestinya.</p>
    </div>
...
<script>
    ...
    function generatePreview() {
        const data = {
            ...
            alamat_baru: document.getElementById('alamat_baru').value,
            tgl_datang: formatDate(document.getElementById('tgl_datang').value),
        ...
        setVal('pdf_alamat_baru', data.alamat_baru);
        setVal('pdf_tgl_datang', data.tgl_datang);
    ...
    function downloadPDF() {
        ...
        const opt = {
            margin: 0,
            filename: 'SKD_' + document.getElementById('nama').value + '.pdf',
