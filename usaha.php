...
<head>
    ...
    <title>Surat Keterangan Usaha - Desa Wonosari</title>
    ...
    <style>
        ...
        * { box-sizing: border-box; font-family: 'Figtree', sans-serif; }
        ...
        /* PDF Styles - Standar SKU Ringkas */
        #pdfTemplate {
            display: none; 
            width: 210mm;
            padding: 15mm 20mm;
...
<main>
    <div class="container-form">
        <header class="form-header">
            <h1><br>Layanan Surat Keterangan Usaha</h1>
        </header>

        <div id="successAlert" class="alert">Draft SKU berhasil dibuat!</div>

        <div id="formSection">
            <div class="card">
                <div class="section-title">Data Pemilik Usaha</div>
                <div class="form-grid">
                    <div class="form-group full-width"><label>Nama Lengkap</label><input type="text" id="nama" placeholder="Contoh: BUDI SANTOSO" required></div>
                    <div class="form-group"><label>Umur (Tahun)</label><input type="number" id="umur" placeholder="Contoh: 45" required></div>
                    <div class="form-group"><label>Nomor HP / Telepon</label><input type="text" id="phone" placeholder="Contoh: 081234567890" required></div>
                    <div class="form-group full-width"><label>Alamat Lengkap</label><textarea id="alamat" rows="2" placeholder="Contoh: RT 03 / RW 01 Desa Wonosari"></textarea></div>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div class="form-grid">
                    <div class="form-group full-width"><label>Nama Usaha</label><input type="text" id="nama_usaha" placeholder="Contoh: Warung Makan Barokah" required></div>
                    <div class="form-group full-width"><label>Jenis / Bidang Usaha</label><input type="text" id="jenis_usaha" placeholder="Contoh: Kuliner / Dagang Sembako" required></div>
                </div>
            </div>

            <div class="btn-container">
                <button type="button" onclick="generatePreview()" class="btn-primary">Buat Draft SKU</button>
            </div>
        </div>

        <div id="previewArea">
            <div class="card">
                <h2 style="margin-top:0; color: var(--primary)">Pratinjau SKU</h2>
                <p>Data pemilik: Nama, Umur, Alamat, dan No. HP.</p>
                <div class="btn-container">
...
<div id="pdfTemplate">
    ...
    <div class="surat-title">
        ...
        <p>Nomor : 510 / <span id="pdf_no_urut">...</span> / II / 2024</p>
    </div>
    ...
    <div class="content-section">
        ...
        <table class="data-table" style="margin-left: 20px; margin-top: 10px;">
            ...
            <tr><td>Umur</td><td>:</td><td><span id="pdf_umur"></span> Tahun</td></tr>
            <tr><td>Alamat</td><td>:</td><td id="pdf_alamat"></td></tr>
            <tr><td>No. HP / Telepon</td><td>:</td><td id="pdf_phone"></td></tr>
        </table>

        <p style="margin-top: 15px;">Berdasarkan pengamatan kami dan laporan yang bersangkutan, bahwa nama tersebut di atas benar-benar memiliki usaha sebagai berikut :</p>
        
        <table class="data-table" style="margin-left: 20px; margin-top: 10px;">
            <tr><td width="160">Nama Usaha</td><td width="15">:</td><td><strong id="pdf_nama_usaha"></strong></td></tr>
            <tr><td>Bidang / Jenis Usaha</td><td>:</td><td id="pdf_jenis_usaha"></td></tr>
        </table>

        <p style="margin-top: 15px;">Demikian Surat Keterangan Usaha ini diberikan kepada yang bersangkutan untuk dapat dipergunakan sebagaimana mestinya.</p>
    </div>
...
<script>
    ...
    function generatePreview() {
        ...
        setVal('pdf_umur', data.umur);
        setVal('pdf_phone', data.phone);
        setVal('pdf_alamat', data.alamat);
        setVal('pdf_nama_usaha', data.nama_usaha.toUpperCase());
        setVal('pdf_jenis_usaha', data.jenis_usaha);
    ...
    function downloadPDF() {
        ...
        const opt = {
            margin: 0,
            filename: 'SKU_' + document.getElementById('nama').value + '.pdf',
