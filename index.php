...
<body>
    ...
    <nav class="navbar">
        <div class="container">
            <div class="nav-brand">
                <h1>Desa Wonosari</h1>
                <p class="subtitle">Portal Administrasi</p>
            </div>
            
            <!-- Desktop Menu -->
            <ul class="nav-menu desktop-menu">
                <li><a href="#beranda" class="nav-link">Beranda</a></li>
                <li><a href="#kelahiran" class="nav-link">Kelahiran</a></li>
                <li><a href="#kematian" class="nav-link">Kematian</a></li>
                <li><a href="#pernikahan" class="nav-link">Pernikahan</a></li>
                <li><a href="#menu4" class="nav-link">Layanan</a></li>
                <li><a href="#menu5" class="nav-link">Berita</a></li>
                <li><a href="#menu6" class="nav-link">Kontak</a></li>
            </ul>
    ...
    <div class="mobile-nav" id="mobileNav">
        <ul class="nav-menu mobile-menu">
            <li><a href="#beranda" class="nav-link" data-toggle="mobile-nav">Beranda</a></li>
            <li><a href="#kelahiran" class="nav-link" data-toggle="mobile-nav">Kelahiran</a></li>
            <li><a href="#kematian" class="nav-link" data-toggle="mobile-nav">Kematian</a></li>
            <li><a href="#pernikahan" class="nav-link" data-toggle="mobile-nav">Pernikahan</a></li>
            <li><a href="#menu4" class="nav-link" data-toggle="mobile-nav">Layanan</a></li>
            <li><a href="#menu5" class="nav-link" data-toggle="mobile-nav">Berita</a></li>
            <li><a href="#menu6" class="nav-link" data-toggle="mobile-nav">Kontak</a></li>
        </ul>
    </div>
    ...
    <main>
            ...
            <div class="container">
                <div class="hero-content">
                    ...
                    <div class="hero-buttons">
                        <a href="#kelahiran" class="btn btn-primary">Layanan Kelahiran</a>
                        <a href="#kematian" class="btn btn-secondary">Informasi Lainnya</a>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section id="kematian" class="service-section alt-bg">
            <div class="container">
                <div class="section-header">
                    <h2>Layanan Kematian</h2>
                    <p class="section-subtitle">Pendaftaran dan Informasi Kematian</p>
                </div>
                
                <div class="service-grid">
                    <div class="service-card">
                        <div class="card-icon"><i class="bi bi-pencil-square"></i></div>
                        <h3>Pendaftaran Kematian</h3>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                        <a href="#" class="btn-link">Pelajari Lebih Lanjut →</a>
                    </div>
    ...
    <footer class="footer">
        <div class="container">
            ...
            <div class="footer-bottom">
                <p>&copy; 2025 Pemerintah Desa Wonosari. Semua Hak Dilindungi.</p>
            </div>
        </div>
    </footer>
