...
<head>
    ...
    <title>Surat Keterangan Miskin - Desa Wonosari</title>
    ...
    <style>
        ...
        * { box-sizing: border-box; font-family: 'Figtree', sans-serif; }
        body { background-color: var(--bg); color: var(--text); line-height: 1.6; margin: 0; padding: 0; display: flex; flex-direction: column; min-height: 100vh; }
        
        main { padding-top: 20px; flex: 1; padding-bottom: 40px; }
        ...
        input, textarea { padding: 10px; border: 1px solid var(--border); border-radius: 6px; font-size: 0.95rem; }
...
<main>
    <div class="container-form">
        <header class="form-header">
            <h1><br>Layanan Pembuatan SKTM</h1>
        </header>

        <div id="successAlert" class="alert">Draft Surat Keterangan Miskin berhasil dibuat!</div>

        <div id="formSection">
            <div class="card">
                <div class="section-title">Data Pemohon</div>
                <div class="form-grid">
                    <div class="form-group full-width"><label>Nama Lengkap</label><input type="text" id="nama" placeholder="Contoh: SUPARMAN" required></div>
                    <div class="form-group"><label>Tempat, Tanggal Lahir</label><input type="text" id="ttl" placeholder="Contoh: Kendal, 01-01-1980" required></div>
                    <div class="form-group"><label>Pekerjaan</label><input type="text" id="pekerjaan" placeholder="Contoh: Buruh Harian Lepas" required></div>
                    <div class="form-group full-width"><label>Alamat Lengkap</label><textarea id="alamat" rows="2" placeholder="RT 05 / RW 02 Desa Wonosari"></textarea></div>
                </div>
            </div>

            <div class="card">
                <div class="section-title">Tujuan Penggunaan</div>
                <div class="form-grid">
                    <div class="form-group full-width">
                        <label>Tujuan / Alasan Pembuatan Surat</label>
                        <textarea id="tujuan" rows="3" placeholder="Contoh: Persyaratan pengajuan beasiswa sekolah anak / Keringanan biaya rumah sakit"></textarea>
                    </div>
                </div>
            </div>
        ...
        <div id="previewArea">
            <div class="card">
                <h2 style="margin-top:0; color: var(--primary)">Pratinjau Surat</h2>
                <p>Silahkan periksa detail data pemohon dan tujuan penggunaan surat.</p>
                <div class="btn-container">
...
<div id="pdfTemplate">
    ...
    <div class="surat-title">
        ...
        <p>Nomor : 400 / <span id="pdf_no_urut">...</span> / II / 2024</p>
    </div>
    ...
    <div class="content-section">
        ...
        <p style="margin-top: 15px;">Sepanjang sepengetahuan kami, nama tersebut di atas benar-benar keluarga yang keadaan ekonominya tergolong <strong>Kurang Mampu / Miskin</strong> di wilayah Desa Wonosari Kecamatan Pegandon Kabupaten Kendal.</p>
        
        <p style="margin-top: 15px;">Surat keterangan ini diberikan kepada yang bersangkutan untuk dipergunakan sebagai : <br><em id="pdf_tujuan"></em></p>

        <p style="margin-top: 15px;">Demikian Surat Keterangan Tidak Mampu ini dibuat dengan sebenarnya agar dapat dipergunakan sebagaimana mestinya.</p>
    </div>
...
<script>
    ...
    function downloadPDF() {
        ...
        const opt = {
            margin: 0,
            filename: 'SKTM_' + document.getElementById('nama').value + '.pdf',
